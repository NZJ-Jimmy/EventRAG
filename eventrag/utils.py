...
from eventrag.prompt import PROMPTS
...
logger = logging.getLogger("eventrag")
...
def set_logger(log_file: str, log_level=None):
    ...
    if log_level is not None:
        ...
        logging.getLogger('gql.transport.requests').setLevel(log_level)
